    ...
    <footer className="border-t border-neutral-800">
      <div className="mx-auto flex max-w-5xl flex-col justify-between p-4 text-sm text-neutral-400 md:flex-row">
        ...
        <div className="mt-2 flex items-center space-x-4 md:mt-0">
          <Link href="/about" className="transition-all duration-200 hover:text-cyan-400 hover:underline">
            About
          </Link>
          <Link href="/customers" className="transition-all duration-200 hover:text-cyan-400 hover:underline">
            Customers
          </Link>
          <Link href="/wishlist" className="transition-all duration-200 hover:text-cyan-400 hover:underline">
            Wishlist
          </Link>
          <Link
            href="https://discord.gg/7AsRYpv2"
          ...
          />
          <SocialIcon
            url="https://www.instagram.com/roognis_singoor/"
            target="_blank"
            rel="noopener noreferrer"
